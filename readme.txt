Hi! Thanks for purchase choice theme.
...
timeline need define number of events (in demo - 8) (if you want generate automatic styles for background for items from 1 to xxx ) 
Define this in theme variable file. You can also use static css files to customize :)
